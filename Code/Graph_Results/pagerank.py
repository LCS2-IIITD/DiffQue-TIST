...
# import sys
# sys.path.append('./extras2')
# from plot_ratings import plot

def pagerank(graph, verbose = False, damping=0.85, epsilon=1.0e-5):
    print "damping",damping,"epsilon",epsilon,"verbose",verbose
    inlink_map = {}
    outlink_counts = {}
    ...
    while delta > epsilon:
        print n_iterations, delta, epsilon
        new_ranks = {}
