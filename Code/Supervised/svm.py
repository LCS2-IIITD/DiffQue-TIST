...
bw_centrality = nx.betweenness_centrality(directed_graph, k = 2000, normalized=True)
...
#print bw_centrality
#print ew_centrality
#print ew_centrality.get((1, 2))
#print bw_centrality.get(1)
################################################
...
def preprocess():
    ...
    print('hi')
    for ed in directed_graph.edges_iter():
        v1 = ed[0]
        v2 = ed[1]
        lab = 1
