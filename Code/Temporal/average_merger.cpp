...
{
    ifstream in1;
    in1.open("rank_nodes_pagerank_with_weight.txt");
    ifstream in2;
    in2.open("rank_nodes_pagerank_without_weight.txt");
    ofstream outp1;
    outp1.open("merger.txt");
    ...
    rep(i, 1, N)
    {
        ...
        outp1 << U;
        outp1 << " ";
        outp1 << fixed << setprecision(18) << (0.3*V + 0.7*ma[U]);
        outp1 << endl;
    }
